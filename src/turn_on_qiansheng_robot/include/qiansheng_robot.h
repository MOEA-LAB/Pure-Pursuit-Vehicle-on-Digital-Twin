...
#ifndef __QIANSHENG_ROBOT_H_
#define __QIANSHENG_ROBOT_H_
...
#define GYROSCOPE_RATIO 0.00005326f;
// #define GYROSCOPE_RATIO   0.00013315f;
// #define GYROSCOPE_RATIO   0.00026644f
// #define GYROSCOPE_RATIO   0.00053207f;
// #define GYROSCOPE_RATIO   0.001064f;
...
private:
	...
	// 速度话题订阅回调函数
	void Cmd_Vel_Callback(const geometry_msgs::TwistStampedConstPtr &twist_aux);
